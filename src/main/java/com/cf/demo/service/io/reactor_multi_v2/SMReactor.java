package com.cf.demo.service.io.reactor_multi_v2;

import com.cf.demo.service.io.reactor_multi.MultiThreadHandler;
 ...
 * @date 2020/9/15
 */
public class SMReactor implements Runnable {
    ...
    SMReactor(int port) throws IOException { //Reactor初始化
        ...
        /* 分步处理,第一步, 用 mainReactor 接收accept 连接事件 */
